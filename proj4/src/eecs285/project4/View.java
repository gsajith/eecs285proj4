...
public class View extends JPanel {
	...
	public View() {
		...
		tankRight = new ImageIcon("eecs285/project4/tankImage/tankDraft2.png").getImage();

		tankDown = new ImageIcon("eecs285/project4/tankImage/tankDraft3.png").getImage();

		tankLeft = new ImageIcon("eecs285/project4/tankImage/tankDraft4.png").getImage();
	}
